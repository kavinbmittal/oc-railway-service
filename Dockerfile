...
ARG OPENCLAW_SOURCE_REF=v2026.7.1
RUN echo "openclaw-ref: ${OPENCLAW_SOURCE_REF}" && git clone --depth 1 --branch "${OPENCLAW_SOURCE_REF}" https://github.com/openclaw/openclaw.git .
