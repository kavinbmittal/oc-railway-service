...
export function RunHistory({ runs }) {
  ...
  return (
    <div className="border border-border">
      {/* Header */}
      <div className="grid grid-cols-[1fr_120px_100px_80px_80px] gap-2 px-4 py-2 text-[10px] uppercase tracking-[0.16em] font-mono text-muted-foreground/60 border-b border-border bg-accent/20">
