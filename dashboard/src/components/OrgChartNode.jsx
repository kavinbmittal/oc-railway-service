...
export function OrgChartNode({ node, onClick }) {
  ...
  return (
    <div
      className={`bg-background border ${borderAccent} rounded-lg px-4 py-3 min-w-[160px] max-w-[200px] cursor-pointer hover:bg-accent/30 hover:border-foreground/20 transition-all shadow-sm hover:shadow-md select-none`}
      onClick={onClick}
    >
