   ...
   <div className="flex justify-between items-center">
    <div className="flex gap-2">
     <select
      ...
      className="flex items-center gap-2 rounded-[6px] border border-border bg-card text-[15px] px-3 py-1.5 text-zinc-300 hover:border-zinc-700 transition-colors focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50"
     >
