    ...
    return (
      <div className="space-y-6">
        <div className="h-12 flex items-center">
          <h1 className="text-sm font-semibold uppercase tracking-wider">Org Chart</h1>
        </div>
  ...
  return (
    <div className="space-y-6">
      ...
      {nodes.length === 0 ? (
        ...
        <div className="border border-border rounded-lg bg-muted/10 overflow-x-auto min-h-[400px]">
